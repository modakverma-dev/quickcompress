...
const HomePageContent = () => {
  ...
  return (
    <main className="pb-10  pt-20 w-full h-full px-5 flex flex-col gap-10 row-start-2 items-center">
      <div className="w-full max-w-5xl h-full items-center flex gap-4 flex-col sm:flex-row">
        <UploadImage
          file={file}
          setFile={setFile}
      ...
      <Card className="w-full max-w-2xl mx-auto flex flex-col md:flex-row gap-5 items-center justify-center p-5 min-h-40">
